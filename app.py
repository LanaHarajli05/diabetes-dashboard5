...
However, we other factors like BMI and glucose,HbA1c show very weak correlation.This suggests the need for multifactorial tests rather than relying on a single indicator like weight.")
